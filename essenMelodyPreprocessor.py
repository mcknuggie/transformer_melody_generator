...
class essenMelodyPreprocessor:
    """
    A class for preprocessing meldoies for a Transformer model

    This class take melodies, tokenizes and encodes them, and
...
if __name__ == "__main__":
    # Example
    preprocessor = essenMelodyPreprocessor("altdeu.txt", batch_size=32)
    print(preprocessor._load_dataset())
